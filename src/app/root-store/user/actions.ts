...
export const ReadRequested = createAction('[User Effects] READ User Requested', props<{ id: string }>());
...
export const DeleteRequested = createAction('[User Effects] DELETE User Requested', props<{ id: string }>());
